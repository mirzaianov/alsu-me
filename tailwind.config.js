  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'expand-from-corner': 'expandFromCorner 0.3s ease-out both',
        'button-pulse': 'buttonPulse 1.2s ease infinite',
        'header-fade-in': 'headerFadeIn 0.7s 0.3s ease-in both',
        'logos-fade-in': 'logosFadeIn 0.7s 0.3s ease-in both',
        'hero-foto-fade-in': 'heroFotoFadeIn 0.5s 0.3s ease-in both',
        'hero-text-fade-in': 'heroTextFadeIn 0.5s 0.3s ease-in both',
