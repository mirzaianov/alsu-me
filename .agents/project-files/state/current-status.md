...
- Infinite GSAP marquee timelines are viewport-gated through the shared marquee utilities, and the testimonials carousel reapplies user/modal pause state when responsive timelines rebuild. [Reason why added: continuously repeating transform timelines should not keep compositor work active while offscreen, and user-paused carousel content should stay paused through media-query changes.]
