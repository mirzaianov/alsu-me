...
- 2026-05-05: Raised raster `next/image` output to quality 100 and restored high-resolution hero/about portrait sources with transform-aware `sizes`. [Reason why added: the KAN-110 migration replaced native `img` delivery with Next optimization defaults, which recompressed images at quality 75 and dropped the old portrait tablet assets.]
