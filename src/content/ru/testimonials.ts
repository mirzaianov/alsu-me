...
import type { ImageContent, TestimonialContent } from '../types';

export const testimonialsContent = {
  title: 'Что говорят мои ученики и клиенты',
  introImage: {
    src: testimonials,
    alt: 'Testimonials',
  } satisfies ImageContent,
  introParagraphs: [
    'Мои ученики достигли значительных результатов благодаря нашей совместной работе, и я горжусь их успехами.',
    'Мои клиенты довольны ростом их бизнеса благодаря как письменным, так и устным синхронным переводам.',
  ],
  labels: {
    readMore: 'Читать далее',
    readFullAriaPrefix: 'Читать отзыв полностью:',
    fullReviewTitlePrefix: 'Полный отзыв:',
    closeDialog: 'Закрыть',
  },
  testimonials: [
    {
