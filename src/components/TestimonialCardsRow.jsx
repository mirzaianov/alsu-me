...
const testimonialCardData = [
  ...
  },
  {
    ...
    comment:
      'Обучалась у Алсу Английскому. Мне очень понравилось. Все темы  и уроки структурированы. Доходчиво. Мне было легко. Я не думала вцелом, что Английский оказывается не такой уж и сложный язык. Это я поняла с Алсу, а не в школе когда то , что и говорит о уровне профессионализма. Думала мои мозги 30 летние не поддадутся, но если заниматься, то с таким учителем можно достичь желаемого уровня. И для меня еще важно не только учительские качества, но и человеческие. С Алсу всегда интересно и поучить, и поизучать, но ещё и просто поговорить о жизни и заодно улучшать навыки английского со всех сторон.',
  },
  {
    fullName: 'Дмитрий',
    src: dmitrii,
