...
const PriceTranslatorCard = ({
  ...
  return (
    <div
      className={`price-tutor-card relative flex h-[436px] w-[var(--card-width)] flex-col items-center justify-start gap-[var(--s)] rounded-[var(--s)] bg-[var(--neutral-00)] px-[var(--xs)] pb-[var(--m)] pt-[var(--l)] shadow-[5px_5px_25px_0px_rgba(0,0,0,0.25)]`}
    >
      <h4 className={`min-h-[56px] text-center uppercase`}>{heading}</h4>
      <p>{subheading}</p>
      <h5 className={`text-heading-s uppercase text-[var(--text-20)]`}>
