...
const PriceTranslatorCard = ({
  ...
  return (
    <div className="even:card-fade-in odd:card-fade-in relative flex h-[436px] w-[var(--card-width)] flex-col items-center justify-start gap-[var(--s)] rounded-[var(--s)] bg-neutral-0 px-[var(--xs)] pb-[var(--m)] pt-[var(--l)] shadow-[5px_5px_25px_0px_rgba(0,0,0,0.25)] odd:animate-card-right-fade-in even:animate-card-left-fade-in">
