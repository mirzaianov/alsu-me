...
const HamburgerDropdown = ({ children, isFixed, isDropdownOpen }) => {
  ...
  return ReactDOM.createPortal(
    <div
      className={`z-1000 ${isDropdownOpen ? 'animate-dropdown-open' : 'animate-dropdown-close'} fixed right-[var(--s)] rounded-[var(--xl)] bg-neutral-0/70 shadow-[5px_5px_25px_0px_rgba(0,0,0,0.25)] backdrop-blur-sm ${isFixed ? 'top-[104px]' : 'top-[64px]'}`}
    >
