...
const HamburgerDropdown = ({ children, isFixed }) => {
  ...
  return ReactDOM.createPortal(
    <div
      className={`z-1000 fixed right-[var(--s)] animate-expand-from-corner rounded-[var(--xl)] bg-neutral-0/70 shadow-[5px_5px_25px_0px_rgba(0,0,0,0.25)] backdrop-blur-sm ${isFixed ? 'top-[104px]' : 'top-[64px]'}`}
    >
