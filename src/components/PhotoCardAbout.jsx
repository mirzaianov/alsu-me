...
const PhotoCardAbout = () => {
  return (
    ...
    <div className={`group relative w-[170px]`}>
      {/* Inner Container */}
      <div
        className={`clip-path-about duration-250 relative flex h-[210px] items-end overflow-hidden transition-transform ease-in-out hover:scale-[1.1]`}
      >
        {/* Color */}
        <div
          className={`absolute bottom-0 left-0 aspect-square w-[170px] rounded-[var(--s)] bg-[var(--primary-50)]`}
        />
        <img
